...
add wave -noupdate -expand -group TOP_1 -group {TX D2C PT} /TB_LTSM_TOP/MODULE_inst_1/i_Transmitter_initiated_Data_to_CLK_done
add wave -noupdate -expand -group TOP_1 -group {TX D2C PT} /TB_LTSM_TOP/MODULE_inst_1/i_Transmitter_initiated_Data_to_CLK_Result
add wave -noupdate -expand -group TOP_1 -group {TX D2C PT} /TB_LTSM_TOP/MODULE_inst_1/o_mainband_or_valtrain_Transmitter_initiated_Data_to_CLK
add wave -noupdate -expand -group TOP_1 -group {TX D2C PT} /TB_LTSM_TOP/MODULE_inst_1/o_lfsr_or_perlane_Transmitter_initiated_Data_to_CLK
add wave -noupdate -expand -group TOP_1 -group {TX D2C PT} /TB_LTSM_TOP/MODULE_inst_1/o_Transmitter_initiated_Data_to_CLK_en
...
add wave -noupdate -expand -group TOP_1 -radix unsigned /TB_LTSM_TOP/MODULE_inst_1/o_encoded_SB_msg
...
add wave -noupdate -expand -group TOP_1 -group {pattern gen/comp} /TB_LTSM_TOP/i_pattern_generation_done_1
add wave -noupdate -expand -group TOP_1 -group {pattern gen/comp} -radix binary /TB_LTSM_TOP/i_comparsion_results_1
add wave -noupdate -expand -group TOP_1 -group {vref & func lanes} /TB_LTSM_TOP/o_reciever_ref_volatge_1
add wave -noupdate -expand -group TOP_1 -group {vref & func lanes} /TB_LTSM_TOP/o_functional_tx_lanes_1
add wave -noupdate -expand -group TOP_1 -group {vref & func lanes} /TB_LTSM_TOP/o_functional_rx_lanes_1
...
add wave -noupdate -radix unsigned /TB_LTSM_TOP/MODULE_inst_1/timeout_counter
add wave -noupdate /TB_LTSM_TOP/MODULE_inst_1/state_timeout
add wave -noupdate /TB_LTSM_TOP/MODULE_inst_1/reset_timeout_counter
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {9098 ns} 0}
...
update
WaveRestoreZoom {9049 ns} {9191 ns}
